...
return (
  <div className="bar" ref={menuRef}>
    <div className="left">
      ...
      <button
        className={`menuItem ${activeMenu === "about" ? "activeMenuItem" : ""}`}
      ...
      >
        ...
        {activeMenu === "about" && (
          <div className="dropdown">
            <div className="dropdownItem" onClick={() => handleItemClick("about")}>
              About Me
            </div>
            <div className="dropdownItem" onClick={() => handleItemClick("projects")}>
              Projects
            </div>
          </div>
        )}
      ...
      <button
        className={`menuItem ${activeMenu === "file" ? "activeMenuItem" : ""}`}
      ...
      >
        ...
        {activeMenu === "file" && (
          <div className="dropdown">
            <div className="dropdownItem">About Me</div>
            <div className="dropdownItem">Projects</div>
          </div>
        )}
      </button>
      ...
      <button
        className={`menuItem ${activeMenu === "edit" ? "activeMenuItem" : ""}`}
      ...
      >
        ...
        {activeMenu === "edit" && (
          <div className="dropdown">
            <div className="dropdownItem">Undo</div>
            <div className="dropdownItem">Redo</div>
          </div>
        )}
      </button>
